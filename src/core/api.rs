...
///
/// ```ignore
/// use unistructgen::core::api::EnumGen;
///
...
///
/// ```ignore
/// use unistructgen::core::api::{ModuleGen, StructGen, EnumGen, FieldType};
///
...
///
/// ```ignore
/// use unistructgen::core::api::from_json;
///
/// let code = from_json(r#"{"id": 1, "name": "Alice"}"#)
///     .struct_name("User")
///     .with_serde()
