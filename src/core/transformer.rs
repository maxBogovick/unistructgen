...
///
/// ```
/// use unistructgen::core::{IRModule, IRTransformer, TransformError};
///
...
/// use unistructgen::core::IRTransformer;
///
...
///
/// ```
/// use unistructgen::core::transformer::DocCommentAdder;
///
...
///
/// ```
/// use unistructgen::core::transformer::TypeDeduplicator;
///
...
///
/// ```
/// use unistructgen::core::transformer::FieldRenamer;
...
mod tests {
    ...
    fn create_test_struct(name: &str, fields: Vec<(&str, IRTypeRef)>) -> IRStruct {
        ...
        for (field_name, ty) in fields {
            let field = crate::core::IRField::new(field_name.to_string(), ty);
            s.add_field(field);
        }
        s
    }
