...
use crate::{IREnum, IRField, IRModule, IRStruct, IRType, IRTypeRef};
...
///
/// ```
/// use unistructgen_core::{IRVisitor, IRModule, IRStruct, walk_struct};
///
...
///
/// ```
/// use unistructgen_core::{IRModule, IRStruct, IRType, IRVisitor, visitor::StructNameCollector};
///
...
///
/// ```
/// use unistructgen_core::{IRModule, IRStruct, IRField, IRType, IRTypeRef, PrimitiveKind, IRVisitor, visitor::FieldCounter};
///
/// let mut module = IRModule::new("Test".to_string());
...
///
/// ```
/// use unistructgen_core::{IRModule, IRStruct, IRField, IRType, IRTypeRef, PrimitiveKind, IRVisitor, visitor::PrimitiveTypeCollector};
///
/// let mut module = IRModule::new("Test".to_string());
/// let mut s = IRStruct::new("User".to_string());
/// s.add_field(IRField::new("id".to_string(), IRTypeRef::Primitive(PrimitiveKind::I64)));
...
pub struct PrimitiveTypeCollector {
    types: std::collections::HashSet<crate::PrimitiveKind>,
}
...
impl PrimitiveTypeCollector {
    ...
    pub fn types(&self) -> &std::collections::HashSet<crate::PrimitiveKind> {
        &self.types
    }

    /// Take ownership of the collected types
    pub fn into_types(self) -> std::collections::HashSet<crate::PrimitiveKind> {
        self.types
    }
}
...
///
/// ```
/// use unistructgen_core::{IRModule, IRStruct, IRType, IRVisitor, visitor::IRValidator};
///
/// let mut module = IRModule::new("Test".to_string());
