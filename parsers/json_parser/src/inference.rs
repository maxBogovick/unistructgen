...
/// ```
/// use serde_json::Value;
/// use unistructgen_json_parser::inference::{TypeInferenceStrategy, InferenceError};
/// use unistructgen_core::{IRTypeRef, PrimitiveKind};
///
...
///
/// ```
/// use unistructgen_json_parser::inference::{SmartTypeInference, TypeInferenceStrategy};
/// use serde_json::json;
///
